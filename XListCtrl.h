#if !defined(AFX_XLISTCTRL_H__57858B90_4B5F_46F5_93FF_AC56D306B20F__INCLUDED_)
#define AFX_XLISTCTRL_H__57858B90_4B5F_46F5_93FF_AC56D306B20F__INCLUDED_
...
struct XLISTCTRLDATA
{
	...
	XLISTCTRLDATA()
	{
		...
		bEdit                = FALSE;
		eEditType			 = CXEdit::TEXT;
		nEditLength			 = 0; //0 means no limit	
	...
	CXEdit::Type	eEditType;				// type of edit control - text/hex/dec/bin
	int				nEditLength;			// Number of characters
...
public:
	...
	BOOL	SetEdit(int nItem, int nSubItem, CXEdit::Type p_eEditType, int p_edit_length=0);
...
#endif // !defined(AFX_XLISTCTRL_H__57858B90_4B5F_46F5_93FF_AC56D306B20F__INCLUDED_)
